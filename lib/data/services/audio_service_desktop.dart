...
/// Audio service implementation for desktop platforms (Windows/Linux/macOS)
///
/// Uses media_kit for direct playback (no background service needed)
class DesktopAudioService implements AudioService {
  ...
  void _initPlayer() {
    _player = Player();
    debugPrint('DesktopAudioService: Created media_kit Player for ${Platform.operatingSystem}');
  }
  ...
  Future<void> play(Song song) async {
    try {
      ...
      debugPrint('DesktopAudioService: Playing ${song.title}');
    } catch (e) {
      debugPrint('DesktopAudioService: Failed to play song: $e');
